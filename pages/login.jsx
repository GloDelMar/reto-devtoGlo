    ...
    <form onSubmit={handleLogin} className="flex flex-col items-center gap-4 w-96 lg:w-1/3 md:w-1/2 sm:w-96">
        <div className="flex flex-col w-full mb-4">
          ...
          <div className="relative">
            <input
              className="border border-gray-400 px-2 py-1 pr-8"
        ...
        <div className="flex items-center flex-col justify-between w-full">
          <button className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-500 w-full mb-8" onClick={handleLogin}>
            Log in
          </button>
